...
class MetaLayerSlide extends MetaSlide {
    ...
    public function register_admin_scripts() {
        ...
        wp_localize_script('metasliderpro-layer-editor-script', 'metasliderpro', array(
            ...
            'noLayerSelected' => __("Warning: No layer selected. Please click on a layer to select it before applying changes.", 'ml-slider-pro')
        ));
    }
    ...
    protected function get_admin_slide() {
        ...
        $row .= "           <button class='update-image image-button' data-button-text='" . __("Update slide image", "ml-slider") . "' title='" . __("Update slide image", "ml-slider") . "' data-slide-id='{$this->slide->ID}' data-attachment-id='{$attachment_id}'>";
    ...
    public function get_admin_tabs() {
        ...
        $extra_tab =    "<div class='row'><label>" . __("Background Image Link", "ml-slider-pro") . "</label></div>
                        <input class='url' type='text' name='attachment[{$slide_id}][url]' placeholder='" . __("URL", 'ml-slider-pro') . "' value='{$url}' />
        ...
        $video_tab =    "<div class='row'><label>" . __("MP4 Source", "ml-slider-pro") . "</label></div>
                        <input class='url' type='text' name='attachment[{$slide_id}][mp4]' placeholder='" . __("URL", 'ml-slider-pro') . "' value='{$mp4}' />
