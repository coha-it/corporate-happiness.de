...
class WC_GZDP_PDF extends FPDI {
    ...
    public function Footer() {
        ...
        if ( 'yes' === $this->object->get_option( 'show_page_numbers' ) ) {
            ...
            $this->SetObjectFont();
       	    $this->writeCustomHTML( '<table width="' . ( $this->getPageWidthRemaining() + 10 ) . '" border="0" cellspacing="0" cellpadding="0"><tr align="right"><td>' . $this->pagination_format() . '</td></tr></table>', array( 'classes' => array( 'footer-page-numbers' ), 'align' => 'R' ) );
