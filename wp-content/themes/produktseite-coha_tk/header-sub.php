...
<?php // substitute the class "container-fluid" below if you want a wider content area ?>
	...
	<div id="temp-subnav-navigation" class="temp-container-subnav">
		<div class="row">

			<div id="navbar-subnav" class="navbar-subnav">
			<ul class="subnav">
			<li><script>
    document.write('<a style="border-right:1px solid #999fa8" href="' + document.referrer + '">Zurück zur Hauptseite</a>');
</script></li> 
			<li><?php
