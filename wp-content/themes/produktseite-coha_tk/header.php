		...
		<div class="row">
				...
				<div class="site-navigation-inner">
					<div class="navbar-header">
						...
						<a href="<?php echo esc_url( home_url( '/' ) ); ?>" title="<?php echo esc_attr( get_bloginfo( 'name', 'display' ) ); ?>" rel="home"><img src="<?php echo esc_url( home_url( '/' ) ); ?>/wp-content/themes/produktseite-coha_tk/includes/img/coha_logo_web_250.png"/></a>
						</div>
						...
						<a class="navbar-brand" href="<?php echo esc_url( home_url( '/' ) ); ?>" title="<?php echo esc_attr( get_bloginfo( 'name', 'display' ) ); ?>" rel="home"><img src="<?php echo esc_url( home_url( '/' ) ); ?>/wp-content/themes/produktseite-coha_tk/includes/img/coha_logo_web_250.png"></img></a>
					</div >
